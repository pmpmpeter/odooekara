...
class CrossoveredBudget(models.Model):
    ...
    freez_june_month = fields.Boolean("Freeze June")
    freez_july_month = fields.Boolean("Freeze July")
    freez_august_month = fields.Boolean("Freeze August")
    freez_september_month = fields.Boolean("Freeze September")
    freez_october_month = fields.Boolean("Freeze October")
    freez_november_month = fields.Boolean("Freeze November")
    freez_december_month = fields.Boolean("Freeze December")
    freez_january_month = fields.Boolean("Freeze January")
    freez_february_month = fields.Boolean("Freeze February")
    freez_march_month = fields.Boolean("Freeze March")
    cash_balance_apr = fields.Float(string='Cash Balance as on 1st April', copy=False)

    rf_freez_april_month = fields.Boolean("Freeze April")
    rf_freez_may_month = fields.Boolean("Freeze May")
    rf_freez_june_month = fields.Boolean("Freeze June")
    rf_freez_july_month = fields.Boolean("Freeze July")
    rf_freez_august_month = fields.Boolean("Freeze August")
    rf_freez_september_month = fields.Boolean("Freeze September")
    rf_freez_october_month = fields.Boolean("Freeze October")
    rf_freez_november_month = fields.Boolean("Freeze November")
    rf_freez_december_month = fields.Boolean("Freeze December")
    rf_freez_january_month = fields.Boolean("Freeze January")
    rf_freez_february_month = fields.Boolean("Freeze February")
    rf_freez_march_month = fields.Boolean("Freeze March")
...
class CrrBudgetLine(models.Model):
    ...
    is_actual_surples = fields.Boolean('Is Actual Surplus')
    is_budget_total = fields.Boolean('Is Budget Total')
    is_consolidated = fields.Boolean('Is Consolidated')
    is_buget_categ = fields.Boolean('Is Budget category')
